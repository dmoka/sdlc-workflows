...
tagline: A directory of markdown files the agent reads at session start and writes to at session end — its working memory between runs.
...
sources:
  ...
  - title: Beads, the external-memory pattern
    url: https://github.com/jamiehannaford/beads
    year: 2025
related:
