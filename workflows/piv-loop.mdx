...
The loop is iterative by design. When validation fails, the user feeds the specific failure back as a discrete fix prompt rather than re-running the full Implement phase. The workshop ships 15 reusable Claude Code commands that drop into any project.
